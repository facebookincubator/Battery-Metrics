...
public class DiskMetricsCollectorTest
  ...
  @Test
  public void testFirstSnapshotReturnsZeroes() throws Exception {
    String io =
        "rchar: 100\n"
            + "wchar: 101\n"
            + "syscr: 1000\n"
    ...
    assertThat(snapshot.rcharBytes).isEqualTo(0);
    assertThat(snapshot.wcharBytes).isEqualTo(0);
    assertThat(snapshot.syscrCount).isEqualTo(0);
    assertThat(snapshot.syscwCount).isEqualTo(0);
    assertThat(snapshot.readBytes).isEqualTo(0);
    assertThat(snapshot.writeBytes).isEqualTo(0);
    assertThat(snapshot.cancelledWriteBytes).isEqualTo(0);
    assertThat(snapshot.majorFaults).isEqualTo(0);
    assertThat(snapshot.blkIoTicks).isEqualTo(0);
  }
